...
#include "customer.h"   //For using customer structure
#define size 100    //The maximum size of database/inventory
...
void CustomerSection()
{
    ...
    // Load/check for customer file once on entry
...
int main(){
    ...
    do{
        ...
        switch (userinput){
            ...
            // Directs control to the Customer menu logic
            CustomerSection();
            break;
            case 4:
